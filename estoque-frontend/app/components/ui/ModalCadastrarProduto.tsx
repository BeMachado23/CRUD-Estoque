          ...
          <div className="flex flex-col xl:flex-row gap-4 xl:gap-6">
            ...
            <div className="w-full xl:w-40">
              ...
              <select
                ...
                className={`w-full bg-gray-200 rounded-md px-3 py-2 xl:px-4 xl:py-2.5 text-sm xl:text-base text-gray-800 outline-none focus:ring-2 cursor-pointer ${unidadeErro ? 'focus:ring-red-500 ring-2 ring-red-500' : 'focus:ring-[#f5c518]'}`}
              >
